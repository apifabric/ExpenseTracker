...
resourcename="expensetracker"  # lower case, only
resourcegroup="expensetracker_rg"
...
# git clone https://github.com/apilogicserver/expensetracker.git
# cd expensetracker
...
az group create --name expensetracker_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group expensetracker_rg --sku S1 --is-linux
az container create --resource-group expensetracker_rg --name expensetracker --image apilogicserver/expensetracker:latest --dns-name-label expensetracker --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//expensetracker.westus.azurecontainer.io:5656'
